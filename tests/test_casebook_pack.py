"""Regression checks for the rivet-svc-gateway-pipe casebook."""
...
from casebook.harness import assert_expected, rivet_svc_gateway_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rivet_svc_gateway_pipe_summary(), assert_expected())
